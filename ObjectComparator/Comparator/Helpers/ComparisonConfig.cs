...
public sealed class ComparisonConfig<T>
{
    ...
    internal Dictionary<string, ICustomCompareValues> GetPropertyStrategies()
    {
        return _propertyStrategies;
    }

    internal Dictionary<Type, ICustomCompareValues> GetTypeStrategies()
    {
        return _typeStrategies;
    }

    internal IEnumerable<string> GetIgnoreProperties()
    {
        return _ignoreProperties;
    }

    internal Func<string, bool>? GetCustomIgnoreStrategy()
    {
        return _customIgnoreStrategy;
    }

    internal ISet<StrategyType> GetSkippedStrategies()
    {
        return _skippedStrategies;
    }
